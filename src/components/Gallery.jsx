        ...
        <div className="container page-content" style={{ paddingBottom: '5rem' }}>
            ...
            <div className="gallery-header">
                ...
                <p className="gallery-intro">
                    Explore life at D.R.P. Convent Public School — from academic achievements and smart laboratories to vibrant cultural fests, health initiatives, and student orientations.
                </p>
            </div>
                            ...
                            <div className="gallery-card-img-wrapper">
                                ...
                                <div className="gallery-card-overlay">
                                    ...
                                    <div className="gallery-card-footer">
                                        <span>{img.date || 'D.R.P. School'}</span>
